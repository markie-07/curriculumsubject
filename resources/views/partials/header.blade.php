<header class="flex justify-between items-center p-2 sm:p-4 bg-white text-gray-800 shadow-md border-b-2 border-gray-200">
    <div class="flex items-center">
        <button id="sidebar-toggle" class="text-gray-600 hover:text-gray-800 focus:outline-none touch-friendly lg:hidden">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path></svg>
        </button>
        <button id="sidebar-toggle-desktop" class="text-gray-600 hover:text-gray-800 focus:outline-none touch-friendly hidden lg:block">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path></svg>
        </button>
    </div>
    <div class="flex items-center space-x-2 sm:space-x-4 lg:space-x-6">
        ...
        <div class="flex items-center space-x-2 sm:space-x-3">
            ...
            <div class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center touch-friendly">
